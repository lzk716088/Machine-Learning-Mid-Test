...
def Inception_create_and_fit_model(train_generator, validation_generator, summary=True, fit=True, epochs=EPOCHS):
    ...
    callbacks = [EarlyStopping(monitor="val_loss", patience=10, verbose=1, mode="min"), 
             ModelCheckpoint(filepath="mymodel_inceptionv3.h5", monitor="val_loss", mode="min", save_best_only=True, save_weights_only=False, verbose=1)]
...
# 載入模型
model = tf.keras.models.load_model('mymodel_inceptionv3.h5')
