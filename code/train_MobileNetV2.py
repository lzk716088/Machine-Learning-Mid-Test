...
def MobileNetV2_create_and_fit_model(train_generator, validation_generator, summary=True, fit=True, epochs=EPOCHS):
    model = Sequential()
    ...
    callbacks = [EarlyStopping(monitor="val_loss", patience=10, verbose=1, mode="min"), 
                ModelCheckpoint(filepath="mymodel_MobileNet.h5", monitor="val_loss", mode="min", save_best_only=True, save_weights_only=False, verbose=1)]
...
# 建立並訓練模型
model, history = MobileNetV2_create_and_fit_model(train_generator, validation_generator)
