...
# 載入訓練資料
train_df = pd.read_csv(r"C:\Users\aiialab\Desktop\siang\aoi\train.csv")
...
# 載入測試資料
test_df = pd.read_csv(r"C:\Users\aiialab\Desktop\siang\aoi\test.csv")
...
################### 模型訓練 ###################
def ResNet50V2_create_and_fit_model(train_generator, validation_generator, summary=True, fit=True, epochs=EPOCHS):
    model = Sequential()
    ...
    callbacks = [EarlyStopping(monitor="val_loss", patience=10, verbose=1, mode="min"), 
                ModelCheckpoint(filepath="mymodel_ResNet50V2.h5", monitor="val_loss", mode="min", save_best_only=True, save_weights_only=False, verbose=1)]
...
# 建立並訓練模型
model, history = ResNet50V2_create_and_fit_model(train_generator, validation_generator)

# 載入模型
model = tf.keras.models.load_model('mymodel_ResNet50V2.h5')
